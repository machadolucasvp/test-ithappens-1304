...
CREATE TABLE ES03_ITEM_PEDIDO(
    ...
    ES03_VALOR_UNITARIO NUMERIC NOT NULL ,
    constraint PK_ES03_ITEM_PEDIDO primary key (ES03_COD_ITEM_PEDIDO)
);

CREATE SEQUENCE ES04_PRODUTO_SEQ START 7990;
...
CREATE TABLE ES07_FORMA_PAG(
    ES07_COD_FORMA_PAG BIGINT NOT NULL DEFAULT nextval('public.ES07_FORMA_PAG_SEQ'::regclass),
...
CREATE SEQUENCE ES10_FILIAL_SEQ START 59;
